...
async def webhook(request: Request):
    ...
    # 1️⃣ 기본 진입 조건: GPT가 BUY/SELL 판단 + 점수 3.55점 이상
    if final_decision in ["BUY", "SELL"] and signal_score >= 3.5:
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "- 하지만 반드시 **현재가 기준으로 TP는 ±10 pip 이내**, SL은 반드시 꼭 최근 ATR의 최소 1.3배 이상으로 설정하라. 그렇지 않으면 시장 변동성 대비 손실 확률이 급격히 높아진다.\\n"
